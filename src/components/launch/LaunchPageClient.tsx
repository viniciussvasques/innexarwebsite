...
// Add-ons data
const addons = [
    { id: 'logo-premium', name: 'Premium Logo Design', price: 99, description: 'Advanced logo with 3 concepts + brand guidelines', icon: Palette },
...
export default function LaunchPageClient() {
    ...
    const features = [
        ...
        { icon: Award, title: 'Free Logo Included', desc: 'Simple professional logo design included with your website build.' },
        { icon: Shield, title: '3 Months Free Hosting + Setup', desc: 'We configure and deploy your site and cover the first 3 months of hosting.' },
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        >
                            ...
                            <div className="grid md:grid-cols-2 gap-12">
                                <div>
                                    <h3 className="text-2xl font-bold mb-2">Professional Website Launch</h3>
                                    ...
                                    <ul className="space-y-3 mb-8">
                                        {[
                                            '5 Custom Pages',
                                            'Free basic logo design included',
                                            ...
                                            '30-Day Support',
                                            '3 Months Free Managed Hosting + Installation',
                                            'Then just $9.99/month hosting after 3 months',
                                        ].map((item, i) => (
